...
export default function SurveyPage() {
  ...
  var surveyJSON = {
    logoPosition: "right",
    //questionTitlePattern: "numTitle", This line can be used to remove the required symbol from questions if need be
    pages: [
      {
        name: "page1",
        elements: [
            ...
            elements: [
              {
                ...
                name: "question2",
                title:
                  "<center>PART 1</center>How comfortable did the therapist appear to you in PART 1 of the session as it relates to dialogue around the client’s cultural identity or cultural issues? </br></br> The therapist appeared....",
                isRequired: true,
                columns: [
              ...
              {
                type: "matrix",
                name: "question2_part2",
                title:
                  "<center>PART 2</center>How comfortable did the therapist appear to you in PART 2 of the session as it relates to dialogue around the client’s cultural identity or cultural issues? </br></br> The therapist appeared....",
                hideNumber: true,
                isRequired: true,
                columns: [
                  { value: "sd", text: "Strongly Disagree" },
          ...
          },
          {
            ...
            elements: [
              ...
              {
                type: "matrix",
                name: "question3_part2",
                title:
                  "<center>PART 2</center>In PART 2 of the session, regarding the client’s cultural background, the therapist....",
                hideNumber: true,
                isRequired: true,
                columns: [
                  { value: "sd", text: "Strongly Disagree" },
          ...
          },
          {
            ...
            elements: [
              ...
              {
                type: "matrix",
                name: "question4_part2",
                title:
                  "<center>PART 2</center> In PART 2 of the session....",
                hideNumber: true,
                isRequired: true,
                columns: [
                  { value: "sd", text: "Strongly Disagree" },
